<x-custom-modal id="editModal" title="Edit Teacher">
    <!-- Session Status -->
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" wire:model='name' value="{{$teacher->name ?? ''}}" id="nameBasic"
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select wire:model='gender' id="gender" class="form-control">
                        ...
                        <option value="male" @if ($teacher && $teacher->gender == 'male')
                            selected
                            @endif>Male</option>
                        <option value="female" @if ($teacher && $teacher->gender == 'female')
                            selected
                            @endif>Female</option>
                    </select>
