<head>
    ...
    <link rel="stylesheet" href="{{asset('teacher-assets')}}/vendor/fonts/boxicons.css" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="{{asset('teacher-assets')}}/vendor/css/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{asset('teacher-assets')}}/vendor/css/theme-default.css" class="template-customizer-theme-css" />
